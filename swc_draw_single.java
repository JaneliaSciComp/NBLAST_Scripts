...
public class swc_draw_single implements PlugIn {
	...
	public void run(String arg) {
		...
		if (in == null) return;
		SaveDialog svd = new SaveDialog("output mip", FilenameUtils.getBaseName(in), ".png");
		String out = svd.getDirectory() + svd.getFileName();
		if (out == null) return;
		if (!showDialog())
            return;
